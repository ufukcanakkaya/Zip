...
extension Zip {
  ...
  /**
     ...
     - returns: NSURL of the destination folder.
     */
  public class func quickUnzipFile(_ path: URL, progress: ((_ progress: Double) -> Void)?) throws
    -> URL
  {
  ...
  /**
     ...
     - returns: NSURL of the destination folder.
     */
  public class func quickZipFiles(
    _ paths: [URL],
    fileName: String,
    ...
    #else
      let documentsUrl =
        fileManager.urls(for: self.searchPathDirectory(), in: .userDomainMask)[0] as URL
    #endif
